...
public class DashboardService {
    ...
    public DashboardResponse getDashboardData(String timeFilter) {
        LocalDateTime[] dateRange = getDateRange(timeFilter);
    ...
    private LocalDateTime[] getDateRange(String timeFilter) {
