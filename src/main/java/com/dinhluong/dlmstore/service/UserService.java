...
public class UserService {
        ...
        // SỬA LỖI: Đổi lại trả về List<UserResponse> vì UserDetailResponse không có
        // roleName
        ...
        public UserDashboardStats getUserStatistics() {
                long total = userRepository.count();
                long active = userRepository.countByIsEnabledTrue();
                long locked = userRepository.countByIsEnabledFalse();
        ...
        public UserDetailResponse getUserDetail(Long userId) {
                ...
                List<UserDetailResponse.AddressDto> addressDtos = addresses.stream()
                                .map(addr -> {
                                        ...
                                        String fullAddress = addr.getStreet() + ", " + addr.getCity() + ", "
                                                        + addr.getProvince() + ", " + addr.getCountry();
                ...
                BigDecimal totalSpent = orderRepository.getTotalSpentByUserIdAndStatus(userId,
