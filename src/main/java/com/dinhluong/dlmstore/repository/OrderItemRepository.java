...
List<DashboardProjections.TopProductProjection> getTopProducts(@Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate);
...
List<DashboardProjections.TopBrandProjection> getTopBrands(@Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate);
